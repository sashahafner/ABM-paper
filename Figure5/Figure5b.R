...
matplot(out1$time, out1[, c('CH4_emis_cum_VS')],ylim = c(0,0.03), type = 'l', 
        col = c('orange'), lty = 1, ylab ='')
lines(out2$time,out2$CH4_emis_cum_VS, type = 'l', 
      col = c('purple'), lty = 1, ylab ='',xaxt='n')
lines(out3$time,out3$CH4_emis_cum_VS, type = 'l', 
      col = c('palegreen4'), lty = 1, ylab ='',xaxt='n')
lines(out4$time,out4$CH4_emis_cum_VS, type = 'l', 
      col = c('orange'), lty = 2, ylab ='',xaxt='n')
lines(out5$time,out5$CH4_emis_cum_VS, type = 'l', 
      col = c('purple'), lty = 2, ylab ='',xaxt='n')
lines(out6$time,out6$CH4_emis_cum_VS, type = 'l', 
      col = c('palegreen4'), lty = 2, ylab ='',xaxt='n')
legend(0, 0.03, legend=c("resid frac = 0.5, meth enrich = 5","resid frac = 0.1, meth enrich = 5","resid frac = 0.01, meth enrich = 5","resid frac = 0.5, meth enrich = 0","resid frac = 0.1, meth enrich = 0","resid frac = 0.01, meth enrich = 0"),
