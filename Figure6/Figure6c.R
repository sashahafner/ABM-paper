...
matplot(out1$time_new, out1[, c('CH4_emis_rate_VS')], type = 'l', 
        col = c('blue'), lty = 2,ylab = '', xlim = c(0,730))
lines(out3$time_new, out3$CH4_emis_rate_VS, col="blue", lty = 1)
legend(260, 0.07, legend=c('Temperature','CH4, f_resid = 0.95, CH4, f_resid = 0.1'),
       col=c('black','blue', 'red', 'blue','red'), lty=c(2,1,1,3,3), cex=0.6, box.lty=0, bg = 'transparent')
par(new = TRUE)
