...
plot(x_vector_temperature,Temperature_vector, type="l", lty =1, col = 'red', ylab = 'relative CH4 emission rate change (%)', xlab = 'change in parameter (%)', xlim =c(-50,50))
lines(x_vector,Sp_vector, col = 'palegreen4')
lines(x_vector,residual_fraction_vector, col = 'blue')
legend(-50, 30, legend=c("Temperature","Sp","residual fraction"), col=c("red","palegreen4","blue"), lty = c(1,1,1), cex = 0.6, box.lty = 0, bg='transparent')
dev.off()