...
plot(out5$time,out5$rCH4/1000, type = "l", xlim =c(3650-730,3650), col ='red', ylim = c(0,250), ylab ='CH4 emission rate (g/d)', xlab = 'Time (d)')
lines(out6$time,out6$rCH4/1000, type = "l", xlim =c(3650-730,3650), col ='blue')
lines(out7$time,out7$rCH4/1000, type = "l", xlim =c(3650-730,3650), col ='orange')
points(meas$time,meas$emis_rate/1000, type = 'o', col ='black',cex=0.6)
legend(2910, 250, legend=c("qhat,max,opt = 50% of default","qhat,max,opt = 75% of default" ,"qhat,max,opt = default","Kariyapperuma et al. 2018"), col=c("red","blue","orange","black"), lty = c(1,1,1,NA), pch = c(NA,NA,NA,1), cex = 0.6, box.lty = 0, bg='transparent')
