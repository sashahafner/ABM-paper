tiff('../fig_output/Fig7.tiff', width = 6, height = 3, pointsize = 9, units = 'in', res = 600)
  ...
  # part a
  matplot(out1$time_new, out1[, c('m1','m2','m3','m4','m5')]/1000, type = 'l', 
          col = c('blue', 'orange','palegreen4','purple','red'), lty = 1, xlim = c(0, 1000),
          xlab = 'Time (d)',
          ylab = expression('Methanogen biomass'~(kg['COD-B']))) 
  legend(200, 12, legend=c('pH','m1','m2','m3','m4','m5'),
